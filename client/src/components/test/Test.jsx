        ...
        <div className={`container ${styles.body}`}>
            <div className={`card ${styles.card}`}>
                <div className="card-body">
                    ...
                    <h6 className={`card-subtitle ${styles.cardSubtitle}`}>globe type chair for rest</h6>
                    <div className="row">
                        ...
                        <div className="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div className="table-responsive">
                                <table className={`table table-striped table-product ${styles.tableProduct}`}>
                                    <tbody>
                                        <tr>

            ...
            <nav className="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div className="collapse navbar-collapse" id="navbarCollapse">
                    <div className="navbar-nav ms-auto py-0">
                        ...
                        <a className="nav-item nav-link" href="packages.html">Packages</a>
                        ...
                        <div className="nav-item dropdown">
                            ...
                            <div className="dropdown-menu m-0">
                                ...
                                <a className="dropdown-item" href="tour.html">Explore Tour</a>
                                <a className="dropdown-item" href="booking.html">Travel Booking</a>
                                <a className="dropdown-item" href="gallery.html">Our Gallery</a>
                                <a className="dropdown-item" href="guides.html">Travel Guides</a>

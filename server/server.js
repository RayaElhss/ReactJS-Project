(function (global, factory) {
    ...
    var seedData = {
        blogs: {
            "7e2030c9-ba93-4bca-bbf0-9acbb9f1fd66": {
                "_ownerId": "60f0cf0b-34b0-4abd-9769-8c42f830dffc",
                "title": "A Journey through the Alps",
                "imageUrl": "https://ttgasia.2017.ttgasia.com/wp-content/uploads/sites/2/2019/03/paragliding.jpg",
                "description": "Exploring the stunning landscapes of the Alpine region.",
                "author": "John Doe",
                ...
                "comments": [
                    {
                        "author": "Jane Smith",
                        "content": "Great post! I love the Alps."
                    },
                    {
                        "author": "Mike Brown",
                ...
                "_createdOn": 1722981299716
            },
            "cdfad67d-aaf3-4858-b149-fc58877ab493": {
                "_ownerId": "60f0cf0b-34b0-4abd-9769-8c42f830dffc",
                "title": "Discovering the Sahara Desert",
                "imageUrl": "https://media.licdn.com/dms/image/C4E12AQFXB4RA2fmDcg/article-cover_image-shrink_720_1280/0/1520079367611?e=2147483647&v=beta&t=7oMWLFs8lRI_dvfXIjmwTspyIdlcOo5HJL7duV5wUMY",
                "description": "An adventurous journey into the heart of the Sahara Desert.",
                ...
                "comments": [
                    {
                        "author": "Tom Hanks",
                        "content": "The Sahara is so mesmerizing!"
                    },
                    {
                        "author": "Emily Clarke",
                        "content": "Can't wait to visit after reading this!"
                    }
                ],
    ...
    var rules$1 = {
        ...
        blogs: {
            ".create": ["User"],         // Allow authenticated users to create blogs
            ".read": ["Guest", "User"],  // Allow guests and authenticated users to read blogs
            ".update": ["Owner"],        // Allow only the owner to update their own blogs
            ".delete": ["Owner"],        // Allow only the owner to delete their own blogs
            "*": {                       // Optional: Add field-level rules if needed
                likes: {
                    ".update": ["User"]  // Allow users to update likes
                },
                comments: {
                    ".create": ["User"]  // Allow users to create comments
                }
            }
        }
    };
